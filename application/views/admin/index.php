                     ...
                     <div class="card-body">
                         <div class="row no-gutters align-items-center">
                             <div class="col mr-2">
                                 ...
                                 <?php $total = $jumlah_nominal + $jumlah_bos + $jumlah_lain ?>
                     ...
                     <div class="card-body">
                         <div class="row no-gutters align-items-center">
                             <div class="col mr-2">
                                 ...
                                 <?php $totalout = $out_bos + $out_brs + $out_lain; ?>
                     ...
                     <div class="card-body">
                         <div class="row no-gutters align-items-center">
                             <div class="col mr-2">
                                 ...
                                 <div class="h5 mb-0 font-weight-bold text-gray-800">Rp. <?= number_format($total_peminjaman, 0, ',', '.'); ?></div>
                             </div>
                             <div class="col-auto">
                                 <i class="fas fa-money-bill-wave fa-2x text-gray-300"></i>
                             </div>
                     ...
                     <div class="card-body">
                         <div class="row no-gutters align-items-center">
                             <div class="col mr-2">
                                 ...
                                 <?php $saldo = $total - $totalout + $total_peminjaman; ?>
