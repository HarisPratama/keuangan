        ...
        <div class="card-header py-3">
            <div class="row">
                ...
                <?php if ($content->role == 'Prioritas') : ?>
                    <div class="col-lg-4">
                        <a href="<?= base_url("/siswa/inputkeringanan/$content->nisn") ?>" class="btn btn-info">Input Keringanan</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
                ...
                <table class="table table-bordered table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr class="bg-light">
                            ...
                            <?php $total_keringanan = $content->keringanan * 12; ?>
                            <td> Rp. <?= number_format($content->total_spp - $total_keringanan - $total_spp->total, 0, ',', '.') ?></td>
                            <td> Rp. <?= number_format($total_spp->total + $total_keringanan, 0, ',', '.') ?></td>
                        </tr>
